...
public class AstCharRef
{
  ...
  public AstCharRef()  { ch='#'; id=-1; }
  public AstCharRef(String s,int ind) { ch=s.charAt(ind); if(ch=='#') id=ind; }

  public boolean isValid()    { return ch!='#' || id!=-1; }
  public boolean isSymbolic() { return isValid()&&ch=='#'; }
